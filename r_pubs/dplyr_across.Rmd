...
```
<br>
For each numeric column, the *min*, *max* and *mean* can be calculated for each group in the **cut** column with help of the across function.
<br>
Summarisation is as follows:
<br>
```{r message=FALSE}
